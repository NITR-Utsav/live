<?php
    ...
    $stmt=$con->prepare("SELECT * FROM events WHERE category = 'fun'") or die(mysqli_error($con));
    ...
    _________________________________________________________ -->
        ...
        <div id="heading-breadcrumbs" style="background-image:url(asset/images/background.jpg) !important;margin-bottom:0px;margin-top:4em;">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h1 style="font-family: patua;">FUN EVENTS</h1>
                    </div>
                    <div class="col-md-5">
                        <ul class="breadcrumb">
                            ...
                            <li style="font-family: patua;">FUN EVENTS</li>
                        </ul>
            ...
            <div class="container">
                ...
                <?php
                    while($row=$result->fetch_array(MYSQLI_ASSOC)){
                        ...
                        <a href="./view_fun.php?event='.$row['eid'].'">
                        <div class="product">
                            <div class="image">
                                <img src="./';
								echo $path;

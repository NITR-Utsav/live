...
<body>
	...
	<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
		...
		<table>
			...
			<tr>
				<td>Description:</td>
				<td><textarea type="text" style="width: 360px; height: 60px;" name="description" value="<?php echo $description ?>"></textarea></td>
			</tr>
			<tr>
				<td>Rules:</td>
				<td><textarea type="text" style="width: 360px; height: 60px;" name="rules" value="<?php echo $rules ?>"></textarea></td>
			</tr>
			<tr>
				<td>Judging Criteria:</td>
				<td><textarea type="text" style="width: 360px; height: 60px;" name="criteria" value="<?php echo $criteria ?>"></textarea></td>
			</tr>
			<tr>
				<td>Upload Poster</td>

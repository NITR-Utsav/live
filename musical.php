    ...
    _________________________________________________________ -->
		 ...
		 <div id="heading-breadcrumbs" style="background-image:url(asset/images/background.jpg) !important;margin-bottom:0px;margin-top:4em;">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h1 style="font-family: patua;">PAPON</h1>
                    </div>
                    <div class="col-md-5">
                        <ul class="breadcrumb">
                            ...
                            <li style="font-family: patua;">MUSICAL NIGHT</li>
            ...
            <div class="container">
                ...
                <div class="row portfolio-project">
					...
					<div class="col-sm-4">                           
						<img src="asset/images/events/papon.jpeg" alt="" class="img-responsive">
					...
					<div class="col-sm-8">
                        <div class="col-sm-12" >                            
							<div class="project-more" >
								...
								<p style="color:black;font-family: proxima;font-size:1em;">4th Feb'18</p>
							...
							<div class="col-sm-6" id="share-buttons">
								...
								<!-- Facebook -->
								<a href="https://www.facebook.com/sharer/sharer.php?u=http://nitrutsav.nitrkl.ac.in/musical.php" target="_blank">
									<img src="facebook.png" alt="Facebook" />
								</a>
								
								<a class="hidden-lg" href="whatsapp://send?text=Hey! Come be a part of our comedy night in NITRUTSAV 2018. http://nitrutsav.nitrkl.ac.in/musical.php" data-action="share/whatsapp/share">
							...
							<div class="tabs" >
								...
								<div class="tab-content tab-content-inverse">
									<div class="tab-pane active" style="font-family: proxima;font-size:1.2em;" id="tab2-1">
										A multi-talented singer, whose music ranges from ambient, electronic, acoustic, folk, and new-age Indian classical music, with traces of pentatonic Mongoloid notes, to modern day ghazals, 
										with hits such as "Bulleya", "Moh Moh ke Dhaage", "Humnava", "Sun Le Re", and "Kyon!" to name a few, our guest for the celebrity night is a person who needs no introduction.<br/>

										<br/>A pioneer of modern day fusion, folk music, an integral part of Coke Studio, and an acclaimed Bollywood singer, NITRutsav 2018 proudly presents to you the brilliant, mellifluous, and much loved, Angaraag Mahanta aka PAPON.</br>

										<br/>Catch him live as he works his magic on the 4th of February, only at NITRutsav!<br/>
									</div>

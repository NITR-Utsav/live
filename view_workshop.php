<?php
    ...
    $stmt=$con->prepare("SELECT * FROM events where eid = ? AND (category = 'workshop' OR category = 'exhibition' OR category = 'guest') ") or die(mysqli_error($con));
...
<script>
  ...
  gtag('config', 'UA-111091736-1');
	...
	<meta property="og:url"                 content="http://nitrutsav.nitrkl.ac.in/view_workshop.php?event=<?php echo $event['eid']; ?>" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <ul class="breadcrumb">
                            ...
                            <li><a style="font-family: patua;" href="workshop.php">WORKSHOPS</a>
                            </li>
					...
					<div class="col-sm-8">
                        <div class="col-sm-12" >                            
							...
							<div class="col-sm-6" id="share-buttons">
								...
								<!-- Facebook -->
								<a href="https://www.facebook.com/sharer/sharer.php?u=http://nitrutsav.nitrkl.ac.in/view_workshop.php?event=<?php echo $event['eid']; ?>" target="_blank">
									<img src="facebook.png" alt="Facebook" />
								</a>
								
								<a class="hidden-lg" href="whatsapp://send?text=Hey! Come be a part of our workshop in NITRUTSAV 2018. http://nitrutsav.nitrkl.ac.in/view_workshop.php?event=<?php echo $event['eid']; ?>" data-action="share/whatsapp/share">
